...
- **Specs:** `13` §5 PRP-04, `05` §2, `05` §3, `05` §4, `05` §5, `06` §4, `04` §2, `03` §1, `03` §4, `08` §9; D-019, D-020, D-023, D-094, D-096; Q-059, Q-063.
...
- **Review:** `Surfaces: security, scope, ux`, `Touches red line: yes`, so prompt 2 (review) runs after implementation. `13` §5 marks `Contract change: no`, but D-078 deferred the token routes to this package; treat it as a contract change.
