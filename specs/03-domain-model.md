...
- Every entity except Image MUST be identified by a UUID, so that data from another PC never collides. [input]
- UUIDs MUST be generated by the server. [Q-055]
...
- The default extent is 30 × 20 on a neutral dark background; a map MAY be attached later, after which the grid is calibrated to it. [Q-034]
